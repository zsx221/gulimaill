    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.catId) {
            this.$http({
              url: this.$http.adornUrl(`/gulimall-product/category/info/${this.dataForm.catId}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/gulimall-product/category/${!this.dataForm.catId ? 'save' : 'update'}`),
              method: 'post',
